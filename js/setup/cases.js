export const FAMOUS_CASES = [
    ...
    { p: "United States", d: "Ninety-Five Barrels, More or Less, Alleged Apple Cider Vinegar" },
    { p: "United States", d: "11 1/4 Dozen Packages of Articles Labeled in Part Mrs. Moffat's Shoo-Fly Powders for Drunkenness" },
    { p: "United States", d: "One Package of Japanese Pessaries" },
    { p: "United States", d: "One 1936 Model Ford V-8 De Luxe Coach" },
    { p: "United States", d: "A Quantity of Candy" },
    { p: "United States", d: "449 Cases, Containing Tomato Paste" },
    { p: "United States", d: "Fifty-Three (53) Eclectus Parrots" },
    { p: "United States", d: "An Article Consisting of 50,000 Cardboard Boxes, Each Containing One Pair of Clacker Balls" },
    { p: "United States", d: "Thirty-Seven Photographs" },
    { p: "United States", d: "Eight Thousand Eight Hundred and Fifty Dollars ($8,850) in United States Currency" },
    { p: "United States", d: "One Assortment of 89 Firearms" },
    { p: "United States", d: "One Lucite Ball Containing Lunar Material" },
    { p: "United States", d: "Approximately Thirteen Unoccupied Burial Plots Situated at Forest Lawn Memorial Park's Hollywood Hills Cemetery" },
